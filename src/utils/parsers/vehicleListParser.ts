...
const vehiclePressuresBase = vehicleListing.pick({ tires: true }).shape.tires.unwrap().unwrap().omit({ rear_recommended_pressure: true, front_recommended_pressure: true })


//function deepUnwrap<T extends z.ZodTypeAny>(schema: T): z.infer<T> {
//	if (schema instanceof z.ZodOptional || schema instanceof z.ZodNullable) {
//		return deepUnwrap(schema.unwrap());
//	}
//
//	if (schema instanceof z.ZodObject) {
//		const shape = schema.shape as { [key: string]: z.ZodTypeAny };
//		const unwrappedShape: { [key: string]: any } = {};
//
//		for (const key in shape) {
//			unwrappedShape[key] = deepUnwrap(shape[key]);
//		}
//
//		return unwrappedShape as z.infer<T>;
//	}
//
//	if (schema instanceof z.ZodArray) {
//		return [deepUnwrap(schema.element)] as z.infer<T>;
//	}
//
//	if (schema instanceof z.ZodUnion) {
//		return schema.options.map(deepUnwrap) as z.infer<T>;
//	}
//
//	if (schema instanceof z.ZodIntersection) {
//		return {
//			...deepUnwrap(schema._def.left),
//			...deepUnwrap(schema._def.right),
//		} as z.infer<T>;
//	}
//
...
//}
//
//const p = deepUnwrap(vehiclePressuresBase)
//
//
//
